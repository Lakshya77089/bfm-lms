...
const SectionSeven = () => {
  return (
    ...
    >
      <div className="absolute inset-0  z-0" /> {/* Optional overlay for better contrast */}
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-3xl mx-auto">
        ...
        <h2 className="text-4xl md:text-5xl font-sharp mb-4">
          Time Is Ticking
        </h2>
        ...
        <p className="text-xl md:text-2xl mb-8">
          just for only <span className="font-sharp text-4xl">199</span> USD
        </p>

        <button className="bg-white text-blue-900 px-6 py-3 rounded-lg font-sharp hover:bg-gray-200 transition">
          Pre-Book Course
        </button>
      </div>
    </section>
