...
const Register = () => {
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <Link href="/login" className="text-gray-400 hover:text-indigo-600 cursor-pointer">
        Sign In
      </Link>
      <span className="text-indigo-600 border-b-2 border-indigo-600 cursor-pointer">Sign Up</span>
    </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Join us and explore the platform!</p>
          </div>
